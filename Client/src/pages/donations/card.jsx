...
const DonationCard = ({ image, title, description, goal, raised }) => {
  ...
  return (
    <div className="overflow-hidden rounded-lg shadow-lg bg-white transition-transform duration-300 hover:shadow-xl hover:scale-[1.02]">
      ...
      <div className="p-4">
        {/* محتوى البطاقة */}
        <h3 className="text-xl font-bold mb-2 text-[#2D336B] text-right">{title}</h3>
        ...
        <div className="mt-4 pt-3 border-t border-gray-200 text-center">
          <a href="#" className="text-[#2D336B] hover:text-[#A9B5DF] text-sm font-medium transition-colors duration-300">
            تفاصيل
          </a>
        </div>
      </div>
